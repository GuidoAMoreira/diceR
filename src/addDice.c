/*
 * Entire code copied from
 * https://github.com/wch/r-source/blob/trunk/src/library/stats/src/fft.c
 * Page mentions a few bugs, but it works altogether and it's fast.
 */
...
// #define M_PI_4 0.7853981633974482789994908671360462903976
#define COSRAD 0.3090169943749474706906261567465131162368
#define SINRAD 0.951056516295153556978972411642780815995
#define SQRT3OVER2 0.8660254037844386467637231707529361834727
                  ...
                  int *np, int *nfac)
{
  ...
  c72 = COSRAD;
  s72 = SINRAD;
  s120 = SQRT3OVER2;/* sin(120) = sqrt(3)/2 */
  if(isn <= 0) {
    s72 = -s72;
    s120 = -s120;
    rad = -rad;
